...
pub struct BankVerification {
    pub iban: String,
    pub swift: String,
    pub amount: Option<f64>,        // Optional: No hardcoding required
    pub currency: Option<String>,   // Optional: No hardcoding required
    pub mt103_raw: Option<String>,  // Raw MT103 text string
}
